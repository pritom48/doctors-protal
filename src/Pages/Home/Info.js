...
const Info = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 text-white gap-4 px-5 '>
            <div>
                <div class="card lg:card-side bg-base-100 shadow-xl bg-gradient-to-r from-primary to-secondary pl-5">
            ...
            <div>
                <div class="card lg:card-side bg-accent bg-base-100 shadow-xl pl-5">
